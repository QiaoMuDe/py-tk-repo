...
class BackupActions:
    ...
    OPEN_ORIGINAL_DELETE_BACKUP = "open_original_delete_backup"  # 从源文件打开并删除备份
...
class SimpleBackupDialog:
    ...
    def _create_widgets(self):
        ...
        original_frame = ctk.CTkFrame(file_frame, fg_color="#E0E0E0" if self.theme_mode == "light" else "#2A2A2A")
        ...
        backup_frame = ctk.CTkFrame(file_frame, fg_color="#E0E0E0" if self.theme_mode == "light" else "#2A2A2A")

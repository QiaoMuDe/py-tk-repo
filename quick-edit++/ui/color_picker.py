...
class HexColorPicker(ctk.CTkToplevel):
    ...
    def _create_preset_colors(self, parent):
        ...
        self.preset_colors = [
            ...
            # 红色系
            "#FF0000", "#800000", "#FF6B6B", "#FFA07A",
            # 绿色系
            "#00FF00", "#008000", "#32CD32", "#90EE90",
            # 蓝色系
            "#0000FF", "#000080", "#4169E1", "#87CEEB",
            # 黄色系
            "#FFFF00", "#808000", "#FFD700", "#F0E68C",
            # 紫色系
            "#FF00FF", "#800080", "#9400D3", "#DDA0DD",
            # 青色系
            "#00FFFF", "#008080", "#00CED1", "#48D1CC",
            # 橙色系
            "#FFA500", "#FF8C00", "#FF7F50", "#FF6347",
            # 棕色系
            "#A52A2A", "#8B4513", "#D2691E", "#DEB887"
        ]

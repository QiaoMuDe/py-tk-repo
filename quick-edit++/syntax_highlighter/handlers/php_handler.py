...
class PHPHandler(LanguageHandler):
    ...
    def _setup_language(self):
        ...
        self._keywords = [
            # 基本关键字
            "and", "as", "break", "case", "catch", "class", "clone", "continue", 
            ...
            "object", "mixed", "void", "never", "null", "false", "true", "self", 
            "parent"
        ]
        ...
        self._builtins = [
            ...
            "echo", "explode", "fprintf", "get_html_translation_table", "hebrev", 
            ...
            "strrchr", "strrev", "strripos", "strrpos", "strspn", "strstr", "strtok", 
            "strtolower", "strtoupper", "strtr", "substr_compare", "substr_count", "substr_replace", 
            "substr", "trim", "ucfirst", "ucwords", "vfprintf", "vprintf", "vsprintf", 
            "wordwrap",
            ...
            "array_intersect_ukey", "array_intersect", "array_key_exists", "array_keys", 
            "array_map", "array_merge_recursive", "array_merge", "array_multisort", "array_pad", 
            ...
            "array_walk", "arsort", "asort", "compact", "count", "current", "each", "end", 
            "extract", "in_array", "key", "krsort", "ksort", "list", "natcasesort", "natsort", 
            ...
            "is_infinite", "is_nan", "lcg_value", "log10", "log1p", "log", "max", "min", 
            "mt_getrandmax", "mt_rand", "mt_srand", "octdec", "pi", "pow", "rad2deg", 
            "rand", "round", "sin", "sinh", "sqrt", "srand", "tan", "tanh",
            
            # 日期时间函数
            "checkdate", "date_add", "date_create_from_format", "date_create_immutable_from_format", 
            ...
            "date_sub", "date_sun_info", "date_sunrise", "date_sunset", "date_time_set", 
            "date_timestamp_get", "date_timestamp_set", "date_timezone_get", "date_timezone_set", 
            "date", "getdate", "gettimeofday", "gmdate", "gmmktime", "gmstrftime", 
            "idate", "localtime", "microtime", "mktime", "strftime", "strptime", "strtotime", 
            "time", "timezone_abbreviations_list", "timezone_identifiers_list", "timezone_location_get", 
            "timezone_name_from_abbr", "timezone_name_get", "timezone_offset_get", "timezone_open", 
            "timezone_transitions_get", "timezone_version_get",
            
            # 文件系统函数
            "basename", "chgrp", "chmod", "chown", "clearstatcache", "copy", "dirname", 
            "disk_free_space", "disk_total_space", "diskfreespace", "fclose", "feof", 
            "fflush", "fgetc", "fgetcsv", "fgets", "fgetss", "file_exists", "file_get_contents", 
            "file_put_contents", "file", "fileatime", "filectime", "filegroup", "fileinode", 
            "filemtime", "fileowner", "fileperms", "filesize", "filetype", "flock", "fnmatch", 
            "fopen", "fpassthru", "fputcsv", "fputs", "fread", "fscanf", "fseek", "fstat", 
            "ftell", "ftruncate", "fwrite", "glob", "is_dir", "is_executable", "is_file", 
            "is_link", "is_readable", "is_uploaded_file", "is_writable", "is_writeable", "link", 
            "linkinfo", "lstat", "mkdir", "move_uploaded_file", "parse_ini_file", "parse_ini_string", 
            "pathinfo", "pclose", "popen", "readfile", "readlink", "realpath_cache_get", 
            "realpath", "rename", "rewind", "rmdir", "set_file_buffer", "stat", "symlink", 
            ...
            "mysqli_fetch_field_direct", "mysqli_fetch_field", "mysqli_fetch_fields", "mysqli_fetch_lengths", 
            "mysqli_fetch_object", "mysqli_fetch_row", "mysqli_field_count", "mysqli_field_seek", 
            "mysqli_field_tell", "mysqli_free_result", "mysqli_get_charset", "mysqli_get_client_info", 
            ...
            "mysqli_get_server_stats", "mysqli_get_server_version", "mysqli_get_warnings", 
            ...
            "mysqli_options", "mysqli_ping", "mysqli_poll", "mysqli_prepare", "mysqli_query", 
            "mysqli_real_connect", "mysqli_real_escape_string", "mysqli_real_query", "mysqli_reap_async_query", 
            "mysqli_refresh", "mysqli_release_savepoint", "mysqli_report", "mysqli_rollback", 
            "mysqli_savepoint", "mysqli_select_db", "mysqli_set_charset", "mysqli_set_opt", 
            "mysqli_sqlstate", "mysqli_ssl_set", "mysqli_stat", "mysqli_stmt_affected_rows", 
            "mysqli_stmt_attr_get", "mysqli_stmt_attr_set", "mysqli_stmt_bind_param", 
            "mysqli_stmt_bind_result", "mysqli_stmt_close", "mysqli_stmt_data_seek", 
            "mysqli_stmt_errno", "mysqli_stmt_error", "mysqli_stmt_execute", "mysqli_stmt_fetch", 
            ...
            "mysqli_stmt_num_rows", "mysqli_stmt_param_count", "mysqli_stmt_prepare", 
            "mysqli_stmt_reset", "mysqli_stmt_result_metadata", "mysqli_stmt_send_long_data", 
            "mysqli_stmt_sqlstate", "mysqli_stmt_store_result", "mysqli_store_result", 
            ...
            # 正则表达式函数
            "preg_filter", "preg_grep", "preg_last_error_msg", "preg_last_error", 
            "preg_match_all", "preg_match", "preg_quote", "preg_replace_callback_array", 
            "preg_replace_callback", "preg_replace", "preg_split",
            
            # URL函数
            "base64_decode", "base64_encode", "get_headers", "get_meta_tags", "http_build_query", 
            "parse_url", "rawurldecode", "rawurlencode", "urldecode", "urlencode",
            
            # 变量函数
            "boolval", "debug_zval_dump", "doubleval", "empty", "floatval", "get_defined_vars", 
            "get_resource_type", "gettype", "intval", "is_array", "is_bool", "is_callable", 
            "is_countable", "is_double", "is_float", "is_int", "is_integer", "is_iterable", 
            ...
            # 错误处理函数
            "debug_backtrace", "debug_print_backtrace", "error_clear_last", "error_get_last", 
            "error_log", "error_reporting", "restore_error_handler", "restore_exception_handler", 
            ...
            "session_create_id", "session_decode", "session_destroy", "session_encode", 
            "session_gc", "session_get_cookie_params", "session_id", "session_is_registered", 
            "session_module_name", "session_name", "session_regenerate_id", "session_register_shutdown", 
            "session_register", "session_reset", "session_save_path", "session_set_cookie_params", 
            ...
            # 类和对象函数
            "class_alias", "class_exists", "get_called_class", "get_class_methods", "get_class_vars", 
            "get_class", "get_declared_classes", "get_declared_interfaces", "get_declared_traits", 
            "get_object_vars", "get_parent_class", "interface_exists", "is_a", "is_subclass_of", 
            "method_exists", "property_exists", "trait_exists",
            
            # 命名空间函数
            "__autoload", "spl_autoload_call", "spl_autoload_extensions", "spl_autoload_functions", 
            "spl_autoload_register", "spl_autoload_unregister", "spl_autoload",
            
            # 反射API
            "Reflection", "ReflectionClass", "ReflectionClassConstant", "ReflectionException", 
            "ReflectionExtension", "ReflectionFunction", "ReflectionFunctionAbstract", 
            "ReflectionGenerator", "ReflectionMethod", "ReflectionNamedType", "ReflectionObject", 
            "ReflectionParameter", "ReflectionProperty", "ReflectionReference", "ReflectionType", 
            "ReflectionUnionType", "ReflectionZendExtension",
            
            # 常用类
            "stdClass", "Exception", "ErrorException", "Throwable", "Generator", "Closure", 
            ...
            "GlobIterator", "SplFileInfo", "SplFileObject", "SplTempFileObject", "ArrayObject", 
            "ArrayIterator", "RecursiveArrayIterator", "SplFixedArray", "SplObjectStorage", 
            "PDO", "PDOStatement", "PDOException", "mysqli", "mysqli_stmt", "mysqli_result", 
            "mysqli_warning", "mysqli_sql_exception", "mysqli_driver", "mysqli_exception", 
            "SimpleXMLElement", "SimpleXMLIterator", "DOMDocument", "DOMNode", "DOMNodeList", 
            "DOMElement", "DOMAttr", "DOMText", "DOMComment", "DOMProcessingInstruction", 
            "DOMCdataSection", "DOMDocumentFragment", "DOMDocumentType", "DOMNotation", 
            "DOMEntity", "DOMEntityReference", "DOMImplementation", "DOMNamedNodeMap", 
            "DOMNameSpaceNode", "DOMXPath", "XMLReader", "XMLWriter", "XSLTProcessor", 
            "SoapClient", "SoapServer", "SoapFault", "SoapHeader", "SoapParam", "SoapVar", 
            "CURLFile", "curl_init", "curl_setopt", "curl_exec", "curl_close", "curl_error", 
            "curl_getinfo", "curl_multi_init", "curl_multi_add_handle", "curl_multi_exec", 
            "curl_multi_remove_handle", "curl_multi_close", "curl_multi_getcontent", 
            "curl_multi_info_read", "curl_multi_select", "curl_version"
        ]
        ...
        # 标签样式 - 使用适合PHP语言的配色方案
        self._tag_styles = {
            "php_open": {"foreground": "#C586C0", "font": "bold"},  # 紫色粗体用于PHP开始标记
            "php_close": {"foreground": "#C586C0", "font": "bold"},  # 紫色粗体用于PHP结束标记
            "php_short_open": {"foreground": "#C586C0", "font": "bold"},  # 紫色粗体用于PHP短标记
            "php_asp_open": {"foreground": "#C586C0", "font": "bold"},  # 紫色粗体用于ASP风格标记
            "php_asp_close": {"foreground": "#C586C0", "font": "bold"},  # 紫色粗体用于ASP风格结束标记
            "comment": {"foreground": "#6A9955", "font": "italic"},  # 绿色斜体用于单行注释
            "shell_comment": {"foreground": "#6A9955", "font": "italic"},  # 绿色斜体用于Shell风格注释
            "multiline_comment": {"foreground": "#6A9955", "font": "italic"},  # 绿色斜体用于多行注释
            "doc_comment": {"foreground": "#608B4E", "font": "italic"},  # 深绿色斜体用于文档注释
            ...
            "interface_def": {"foreground": "#569CD6", "font": "bold"},  # 蓝色粗体用于接口定义
            "trait_def": {"foreground": "#569CD6", "font": "bold"},  # 蓝色粗体用于特质定义

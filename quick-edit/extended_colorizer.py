...
class LanguageColorDelegator(ColorDelegator):
    ...
    def _setup_language_patterns(self):
        """设置语言特定的正则表达式模式"""
        # 如果是Python语言，使用父类的默认模式
        if self.language == 'python':
            # 父类已经在__init__中设置了prog，所以不需要重新设置
            return
    ...
    def _get_language_patterns(self):
        ...
        return language_map.get(self.language, self._default_patterns)()
    ...
    def _javascript_patterns(self):
        ...
        js_builtins = [
            ...
            'Object', 'RegExp', 'String', 'Symbol', 'Promise', 'Set', 'Map',
            'console', 'alert', 'prompt', 'confirm', 'document', 'window'
        ]
    ...
    def _html_patterns(self):
        ...
        return [tag_name, attribute, attribute_value, comment, self.any("SYNC", [r"\n"])]
    ...
    def _css_patterns(self):
        ...
        css_properties = [
            ...
            'float', 'clear', 'overflow', 'text-align', 'vertical-align',
        ...
        return [property_name, keyword, value, number, comment, self.any("SYNC", [r"\n"])]
    ...
    def _sql_patterns(self):
        ...
        sql_keywords = [
            ...
            'ON', 'GROUP', 'BY', 'HAVING', 'ORDER', 'LIMIT', 'OFFSET', 'INNER',
            'LEFT', 'RIGHT', 'OUTER', 'FULL', 'CREATE', 'ALTER', 'DROP', 'TABLE',
...
class SyntaxHighlighter:
    ...
    def _configure_colors(self):
        ...
        # 定义颜色映射
        color_map = {
            "KEYWORD": idleConf.GetHighlight(theme, "keyword", default={'foreground': '#0000FF'}),
            "BUILTIN": idleConf.GetHighlight(theme, "builtin", default={'foreground': '#7F7F00'}),
            "STRING": idleConf.GetHighlight(theme, "string", default={'foreground': '#008000'}),
            "COMMENT": idleConf.GetHighlight(theme, "comment", default={'foreground': '#808080'}),

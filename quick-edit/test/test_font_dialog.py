...
class FontDialogTest:
    ...
    def create_ui(self):
        ...
        self.current_font_label = tk.Label(
            self.root, text=f"当前字体: {self.font_family}", font=(self.font_family, 12)
        )
    ...
    def choose_font(self):
        ...
        font_listbox = tk.Listbox(
            frame, yscrollcommand=scrollbar.set, font=("Microsoft YaHei UI", 10)
        )
    ...
    def update_display(self):
        ...
        self.current_font_label.config(
            text=f"当前字体: {self.font_family}", font=(self.font_family, 12)
        )

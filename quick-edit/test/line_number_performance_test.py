...
class LineNumberPerformanceTest:
    def __init__(self, root):
        ...
        # 行号区域
        self.line_numbers = tk.Canvas(self.text_frame, width=50, bg="#f0f0f0", highlightthickness=0)
        ...
        # 测试按钮
        self.test_btn = ttk.Button(self.control_frame, text="测试性能", command=self.run_performance_test)
        ...
        self.text_area.bind("<ButtonRelease>", lambda e: self.schedule_line_number_update(50))
    ...
    def generate_test_data(self):
        ...
        for i in range(1000):
            ...
            line_content = ''.join(random.choices(string.ascii_letters + string.digits + ' ', k=line_length))
    ...
    def run_performance_test(self):
        ...
        self.result_text.insert(tk.END, f"平均行号更新耗时: {average_time:.4f} 毫秒 ({test_count} 次测试)\n")
        self.result_text.see(tk.END)

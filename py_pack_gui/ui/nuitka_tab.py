...
class NuitkaTab:
    ...
    def create_basic_params(self):
        ...
        basic_title = ctk.CTkLabel(
            self.scroll_frame, text="基础参数", font=self.title_font
        )
        ...
        script_browse_btn = ctk.CTkButton(
            script_frame, text="浏览", width=60, command=self.browse_script
        )
        ...
        output_browse_btn = ctk.CTkButton(
            output_frame, text="浏览", width=60, command=self.browse_output
        )
        ...
        icon_browse_btn = ctk.CTkButton(
            icon_frame, text="浏览", width=60, command=self.browse_icon
        )
        ...
        standalone_check = ctk.CTkCheckBox(
            mode_frame, text="独立可执行文件", variable=self.standalone_var
        )
        ...
        console_check = ctk.CTkCheckBox(
            console_frame, text="显示控制台", variable=self.console_var
        )
    ...
    def create_advanced_params(self):
        ...
        advanced_title = ctk.CTkLabel(
            self.scroll_frame, text="高级参数", font=self.title_font
        )
        ...
        self.include_entry.pack(
            side="left", fill="x", expand=True, padx=(0, 5), pady=10
        )

        include_add_btn = ctk.CTkButton(
            include_frame, text="添加", width=60, command=self.add_include_module
        )
        ...
        data_browse_btn = ctk.CTkButton(
            data_frame, text="浏览", width=60, command=self.browse_data_file
        )
        ...
        o0_radio = ctk.CTkRadioButton(
            optimize_frame, text="O0 (无优化)", variable=self.optimize_var, value="O0"
        )
        o0_radio.pack(side="left", padx=(0, 10), pady=10)

        o1_radio = ctk.CTkRadioButton(
            optimize_frame, text="O1 (默认)", variable=self.optimize_var, value="O1"
        )
        o1_radio.pack(side="left", padx=(0, 10), pady=10)

        o2_radio = ctk.CTkRadioButton(
            optimize_frame, text="O2 (更多)", variable=self.optimize_var, value="O2"
        )
    ...
    def browse_icon(self):
        """浏览图标文件"""
        file_path = filedialog.askopenfilename(
            title="选择图标文件", filetypes=[("图标文件", "*.ico"), ("所有文件", "*.*")]
        )
        if file_path:
